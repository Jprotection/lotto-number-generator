...
import static boho.lottonumbergenerator.domain.entity.lotto.QGeneratedLotto.*;
import static boho.lottonumbergenerator.domain.entity.member.QMember.*;
import static boho.lottonumbergenerator.domain.entity.member.QMemberRole.*;
import static boho.lottonumbergenerator.domain.entity.member.QMemberTitle.*;
import static boho.lottonumbergenerator.domain.entity.member.QRole.*;
import static boho.lottonumbergenerator.domain.entity.member.QTitle.*;
...
public class MemberCustomRepositoryImpl implements MemberCustomRepository {
	...
	public MemberInfoResponse findMemberInfo(String username) {
		Map<String, MemberInfoResponse> resultMap = queryFactory
			...
			.leftJoin(memberRole).on(member.eq(memberRole.member))
			.leftJoin(role).on(memberRole.role.eq(role))
